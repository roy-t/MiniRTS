...
namespace MiniEngine.Gui.Editors
{
    ...
    {
        public override void Draw(string name, Func<Vector2> get, Action<Vector2> set)
        {
            var v = get();
    ...
    {
        public override void Draw(string name, Func<Vector3> get, Action<Vector3> set)
        {
            var v = get();
    ...
    {
        public override void Draw(string name, Func<Vector4> get, Action<Vector4> set)
        {
            var v = get();
