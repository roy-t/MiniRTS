...
namespace MiniEngine.Scenes
{
    public sealed class ZScene  : IScene
    {
        ...
        public void Set()
        {
            ...
            this.EmitterFactory.Construct(this.particleEntity2, particleSpawn, this.explosion, 8, 8, 0.25f);

            this.particleEntity3 = this.EntityCreator.CreateEntity();
            this.EmitterFactory.Construct(this.particleEntity3, particleSpawn, this.explosion2, 1, 1, 0.75f);
