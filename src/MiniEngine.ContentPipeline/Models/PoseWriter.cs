...
namespace MiniEngine.ContentPipeline.Models
{
    ...
    public sealed class PoseWriter : ContentTypeWriter<PoseContent>
    {
        ...
        protected override void Write(ContentWriter output, PoseContent value)
        {
            output.Write(value.Offset);

            Write(output, value.Material);
        ...
        {
            output.WriteExternalReference(material.Albedo);
            output.WriteExternalReference(material.Normal);
        }
