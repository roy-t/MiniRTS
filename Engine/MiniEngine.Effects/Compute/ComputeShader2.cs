...
{
    public sealed class ComputeShader2
    {
        ...
        public ComputeShader2(GraphicsDevice device, string fileName, string kernel)
        {
        ...
        private void ReflectInputs(ShaderReflection reflector, string filename)
        {
            for (var i = 0; i < reflector.Description.BoundResources; i++)
            {
                ...
                Debug.WriteLine($"{description.Type} {description.Name} : register({description.BindPoint})");
            ...
            where T : struct
        {
            ...
            switch (binding.ResourceType)
            {
                ...
                case ShaderResourceType.StructuredBuffer:
                    ...
                    break;
                case ShaderResourceType.RWStructuredBuffer:
                    throw new System.NotSupportedException("Cannot upload data to an RWStructuredBuffer");
            }
        }
            ...
            where T : struct
        {
            ...
            {
                case ShaderResourceType.ConstantBuffer:
                    throw new System.NotSupportedException("Use SetResource to upload data to a constant buffer");
                case ShaderResourceType.StructuredBuffer:
                    throw new System.NotSupportedException("Use SetResource to upload data to a structured buffer");
                case ShaderResourceType.RWStructuredBuffer:
